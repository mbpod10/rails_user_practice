...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { address: @information.address, age: @information.age, citizen: @information.citizen, dependent: @information.dependent, marital_status: @information.marital_status, name: @information.name } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { address: @information.address, age: @information.age, citizen: @information.citizen, dependent: @information.dependent, marital_status: @information.marital_status, name: @information.name } }
